...
client.login("Nzc2ODA3NDkwNjE1NTA5MDIz.X66QWg.-ii2sBm_0orvG3Lj7jGIGS2hoJA");
...
client.on("ready", () => {
  client.user.setActivity(`Alfa | Uptime Botu`)
  console.log(`Logined`)
})
...
.setAuthor(`Alfa Uptime | Yardım Menüsü`, client.user.avatarURL)
.setFooter(`Alfa Uptime Botu`)
